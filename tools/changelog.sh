...
cat $ANDROID_BUILD_TOP/vendor/lineage/tools/changelog_header.fhtml > $Changelog
...
cat $ANDROID_BUILD_TOP/vendor/lineage/tools/changelog_footer.fhtml >> $Changelog
