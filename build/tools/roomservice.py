...
custom_dependencies = "h4k3rom.dependencies"
org_manifest = "h4k3rom"  # leave empty if org is provided in manifest
...
def fetch_dependencies(repo_path, fallback_branch=None, first_dependency=False):
    ...
    if first_dependency:
        os.system('vendor/h4k3rom/build/tools/roomcleaner.py %s' % repo_path)
