...
removal_manifest = ".repo/local_manifests/00_h4k3rom_removals.xml"
tmp_removal_manifest = ".repo/local_manifests/tmp_h4k3rom_removals.xml"
...
def fetch_dependencies(repo_path):
    ...
    dependencies_path = repo_path + '/h4k3rom.removal.dependencies'
    syncable_repos = []
...
def remove_removals(removal_manifest):
    tmp_manifest_disable = ".repo/local_manifests/h4k3rom_manifest.xml"
