...
include $(CLEAR_VARS)
LOCAL_SRC_FILES := healthd_board_h4k3rom.cpp
LOCAL_MODULE := libhealthd.h4k3rom
LOCAL_CFLAGS := -Werror
LOCAL_C_INCLUDES := \
...
include $$(CLEAR_VARS)
LOCAL_MODULE := vendor_h4k3rom_charger_$(notdir $(1))
...
include $(CLEAR_VARS)
LOCAL_MODULE := h4k3rom_charger_res_images
LOCAL_MODULE_TAGS := optional
